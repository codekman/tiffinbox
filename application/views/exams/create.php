				...
				<a href="<?php echo base_url();?>exams/index">
					...
					<div class="row-fluid">
						...
						<!--------------Message---------------------------------->
							...
							<?php echo form_open(base_url().'exams/insert','class="form-horizontal"'); 
							...
							?>
							 ...
							 <div class="control-group">
								 ...
								 <div class="controls">
									...
									<input class="input-small input-mask-date" name="examDate" id="form-field-mask-1" type="text">
							...
							<div class="controls">
								<label>
									<input id="form-field-radio1" name="examStatus" checked="" value="1" type="radio">
									<span class="lbl" for="form-field-radio1"> active</span>
								 
									<input id="form-field-radio2" name="examStatus" value="0" type="radio">
