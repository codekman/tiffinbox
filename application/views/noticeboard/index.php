...
<div class="page-content">
	<div class="row-fluid">
		<div class="span12 page-header position-relative">
			<!--PAGE CONTENT BEGINS-->
				<a href="<?php echo base_url();?>noticeboard/create">
									...
									<tbody>
										<tr>
											...
											<td>
												...
												<?php if(@$row->noticeStatus==0):?>
													<span class="label label-warning arrowed"><?php echo $status[@$row->noticeStatus]; ?></span>
												<?php else: ?>
													<span class="label label-success arrowed"><?php echo $status[@$row->noticeStatus]; ?></span>
											...
											<td><?php echo @$row->noticeDate;?></td>
											 ...
											 <td><?php echo substr(@$row->noticeDescription,0,250)."...";?></td> 
											...
											<td class="td-actions">
												<div class="hidden-phone visible-desktop action-buttons">
													...
													<a class="green" href="<?php echo base_url();?>noticeboard/update/<?php echo $row->Id; ?>">
														<i class="icon-pencil bigger-130"></i>
													</a>

													<a class="red" onclick="confirmdelete()" href="<?php echo base_url();?>noticeboard/delete/<?php echo $row->Id; ?>">
