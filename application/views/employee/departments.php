...
function confirmdelete(id){
	...
	bootbox.confirm("Are you sure to delete all information of this Department?", function(result) {
		if(result) {
			$.ajax({
				url: "<?php echo base_url().'employee/deletedepartment';?>",
				type: "POST",
...
<div class="page-content">
	<div class="row-fluid">
		<div class="span12 page-header row-fluid position-relative">
			<!--PAGE CONTENT BEGINS-->
				<a href="<?php echo base_url();?>employee/createdepartment">
								...
								<table id="sample-table-2" class="table table-striped table-bordered table-hover">
									<thead>
										<tr>
											...
											<th><h4 class="smaller blue"><i class="icon-bookmark green"></i> | Departments Name & Status</h4></th>
									...
									<tbody>
										<tr>
											...
											<td>
												<span class="editable editable-click username" style="display: inline;"><?php echo $row->departmentName; ?></span>
														 
																<?php if(@$row->departmentStatus==0):?>
																	<span class="label label-warning arrowed">
																		<?php echo $status[@$row->departmentStatus]; ?>
																	</span>
																<?php else: ?>
											...
											<td class="td-actions"> 
						<a class="green tooltip-error" data-rel="tooltip" data-placement="top" title="" data-original-title="edit department information" href="<?php echo base_url();?>employee/updatedepartment/<?php echo $row->Id; ?>">
