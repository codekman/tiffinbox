					...
					<div class="row-fluid">
						...
						<!--check any alert message or not -->
						 ...
						 <!--Print Wrong Alert Message: -->		
							...
							<?php endif; ?>	
						<!--------------End of Message---------------------------------->
							<?php echo form_open_multipart(base_url().'employee/insertdesignation','class="form-horizontal"'); ?>
					  </div>
							<div class="row-fluid">	 
									<div class="control-group">
										...
										<div class="controls">
											...
											$designationName = array(
												...
												'value'			=> @$this->input->post('designationName')	
											);
							...
							<div class="row-fluid">	
								<div class="control-group">
									<label class="control-label" for="form-field-4">Department</label>
