...
function confirmdelete(){
	var conf = confirm("Are you sure to delete this branch?");
...
<div class="page-content">
	<div class="row-fluid">
		<div class="span12 page-header position-relative">
			<!--PAGE CONTENT BEGINS-->
				<a href="<?php echo base_url();?>school/createbranch">
								...
								<table id="sample-table-2" class="table table-striped table-bordered table-hover">
									...
									<tbody>
										<tr>
											...
											<td>
											<?php echo @$this->db->get_where('schools', array('Id'=>@$row->schoolId))->row()->schoolName; ?>
												
											</td>
											<td>
												<a href="#"><?php echo @$row->branchName.'::'. @$row->branchCode; ?></a>
												
												<?php if(@$row->branchStatus==0):?>
													<span class="label label-warning arrowed">
														<?php echo @$status[@$row->branchStatus]; ?>
													</span>
												<?php else: ?>
											...
											<td><?php echo @$row->branchAddress;?></td>
												...
												<div class="hidden-phone visible-desktop action-buttons">
													...
													<a class="green" href="<?php echo base_url();?>school/updatebranch/<?php echo $row->Id; ?>">
														<i class="icon-pencil bigger-130"></i>
													</a>

													<a class="red" onclick="confirmdelete()" href="<?php echo base_url();?>school/deletebranch/<?php echo $row->Id; ?>">
