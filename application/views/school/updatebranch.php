				...
				<a href="<?php echo base_url();?>school/branches">
					...
					<div class="row-fluid">
						...
						<div class="span12">
							...
							<?php echo form_open(base_url().'school/editbranch','class="form-horizontal"'); 
							?>
							...
							foreach($branch->result() as $row):
								$branchName = array(
									...
									'value'			=> (@$this->input->post('branchName')) ? @$this->input->post('branchName') :$row->branchName
								);
							...
							echo '<br/>'.form_error('branchName','&nbsp;&nbsp;<span class="text-warning orange"><i class="icon-warning-sign"></i>&nbsp;', '</span>');
								...
								$branchCode = array(
									...
									'value'			=> (@$this->input->post('branchCode')) ? @$this->input->post('branchCode') : $row->branchCode
								);
							...
							echo form_dropdown('schoolId',$option, (@$this->input->post('schoolId')) ? @$this->input->post('schoolId') : $row->schoolId);
							...
							?>
							 ...
							 <div class="control-group">
									...
									<div class="controls">
										<textarea name="branchAddress" rows="5" id="form-field-11" class="autosize-transition span3"><?php echo (@$this->input->post('branchAddress')) ? @$this->input->post('branchAddress') : $row->branchAddress;  ?></textarea>
									</div>
								<div>
								<br/>
							 <div class="row-fluid ">
