				...
				<a href="<?php echo base_url();?>school/batch">
					...
					<div class="row-fluid">
						...
						<div class="span12">
							...
							<?php 
							echo form_open(base_url().'school/editbatch','class="form-horizontal"');
							foreach($batch->result() as $row): 
							?>
							 Batch Year <span class="red">*</span><br/>	
										<div class="input-append">
											<input type="text" class="input" name="batchYear"
											value="<?php echo (@$this->input->post('batchYear')) ? @$this->input->post('batchYear') : $row->batchYear; ?>"
											 id=""  style="width: 50px;">
							...
							<?php	
								$batchName = array(
									...
									'value'			=> (@$this->input->post('batchName')) ? @$this->input->post('batchName') : $row->batchName
								);
