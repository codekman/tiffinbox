				...
				<a href="<?php echo base_url();?>school/index">
					...
					<div class="row-fluid">
						...
						<div class="span12">
							...
							<?php echo form_open_multipart(base_url().'school/insert','class="form-horizontal"'); 
							?>
							<div class="row-fluid">
							...
							<?php	
								$schoolName = array(
									...
									'value'			=> $this->input->post('schoolName')
								);
							...
							?>
							 ...
							 <div class="control-group">
									...
									<div class="controls">
										<textarea name="schoolAddress" rows="5" id="form-field-11" class="autosize-transition span3"><?php echo $this->input->post('schoolAddress'); ?></textarea>
									</div>
								<div>
								<br/>
							 <div class="row-fluid ">
							 <div class="span6">	
										...
										<div class="controls in-line">
											<label>
											 ...
											 <label>
												<input id="form-field-radio2" name="schoolStatus" value="2" type="radio">
