...
<div class="page-content">
	<div class="row-fluid">
		<div class="span12 page-header position-relative">
			<!--PAGE CONTENT BEGINS-->
				<a href="<?php echo base_url();?>school/createbatch">
								...
								<table id="sample-table-2" class="table table-striped table-bordered table-hover">
									...
									<tbody>
										<tr>
											...
											<td><a href="#"><?php echo @$row->batchName; ?></a> </td>
											<td>
												<?php echo @$row->batchYear; ?>
												
											</td>	
											<td>	
												<?php if(@$row->batchStatus==0):?>
													<span class="label label-warning arrowed">
														<?php echo @$status[@$row->batchStatus]; ?>
													</span>
												<?php else: ?>
												...
												<div class="hidden-phone visible-desktop action-buttons">
													...
													<a class="green" href="<?php echo base_url();?>school/updatebatch/<?php echo $row->Id; ?>">
														<i class="icon-pencil bigger-130"></i>
													</a>

													<a class="red" onclick="confirmdelete()" href="<?php echo base_url();?>school/deletebatch/<?php echo $row->Id; ?>">
