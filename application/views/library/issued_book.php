							...
							<tr>
								...
								<td class="td-actions">
									<div class="hidden-phone visible-desktop action-buttons">
										<a class="green" href="<?php echo base_url();?>library/updateissue/<?php echo $row->issueId; ?>" data-rel="tooltip" data-placement="top" data-original-title="Edit Issue">
											<i class="icon-pencil bigger-130"></i>
										</a>
										<a class="green" onclick="confirmReturn();" href="<?php echo base_url();?>library/returnbook/<?php echo $row->issueId; ?>" data-rel="tooltip" data-placement="top" data-original-title="Return Book">
											<i class=" icon-reply bigger-130"></i>
										</a>
										<a class="red" onclick="confirmdelete()" href="<?php echo base_url(); ?>library/deleteissue/<?php echo $row->issueId; ?>" data-rel="tooltip" data-placement="top" data-original-title="Delete Book">
