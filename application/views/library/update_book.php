		...
		<div class="row-fluid">
			...
			<!--check any alert message or not -->
			 ...
			 <!--Print Wrong Alert Message: -->		
				...
				<?php endif; ?>	
			<!--------------End of Message---------------------------------->
			<?php echo form_open(base_url().'library/editbook','class="form-horizontal"'); ?>
					   ...
					   <div class="controls">
							<?php	
								...
								$author = array(
									...
									'value'			=> ($this->input->post('author')) ? $this->input->post('author') : $row->author
								);
					   ...
					   <div class="controls">
							<?php	
								...
								$description = array(
									...
									'value'			=> ($this->input->post('description')) ? $this->input->post('description') : $row->description
								);
				...
				<div class="control-group">
					...
					<div class="controls">
						<?php	 
							$price = array(
								...
								'value'			=> ($this->input->post('price')) ? $this->input->post('price') : $row->price
							);
				 ...
				 <div class="control-group">
				   ...
				   <div class="controls">
				 		<input name="status" checked value="1" <?php echo $avi; ?> type="radio"> 
				 		<span class="lbl">&nbsp;&nbsp;Available</span>
				 		<input name="status" value="0" <?php echo $iss; ?>  type="radio">
